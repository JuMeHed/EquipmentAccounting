...
{
    internal class SSDAddEditViewModel : INotifyPropertyChanged
    {
        ...
        private void SetCharacteristics()
        {
            if (CurrentComponent != null)
            {
                ...
                if (!string.IsNullOrWhiteSpace(SelectedMemoryCapacity))
                {
                    ...
                    {
                        ComponentTypeCharacteristicId = 34,
                ...
                if (!string.IsNullOrWhiteSpace(ReadingSpeed))
                {
                    ...
                    {
                        ComponentTypeCharacteristicId = 35,
                        ComponentId = CurrentComponent.Id,
                        Value = ReadingSpeed
                    };
                ...
                if (!string.IsNullOrWhiteSpace(WritingSpeed))
                {
                    ...
                    {
                        ComponentTypeCharacteristicId = 36,
                        ComponentId = CurrentComponent.Id,
                        Value = WritingSpeed
                    };
                ...
                if (!string.IsNullOrWhiteSpace(ConnectionInterface))
                {
                    ...
                    {
                        ComponentTypeCharacteristicId = 37,
                        ComponentId = CurrentComponent.Id,
                ...
                if (!string.IsNullOrWhiteSpace(Power))
                {
                    ...
                    {
                        ComponentTypeCharacteristicId = 38,
                        ComponentId = CurrentComponent.Id,
                        Value = Power
                    };
